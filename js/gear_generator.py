...
function addGearData( parentgearID, axlejoint, N, D, P, PA, A ) {
    var ID = gears.length,
        ...
        newgear = {
            ...
            P: 			P,
            PA:			PA,
            // resulting from this new gear
            rot:		0,		// Of course this is not so
            gearangle:	thegear.gearangle,				
            
            ratio:		1,
            totalratio: 1,
            
            jointangle:	A,			// default that below ...
        ...
        //	geardata:	createGear( N,D,P ),
            ...
            svg:		thegear.svg,
            svgwidth:	thegear.w,		// svg gears size.
            svgheight:	thegear.h,
            svgoffsetx:	-thegear.w/2,		// svg offset a Center point positioning
            svgoffsety:	-thegear.h/2,
            offsetx:	0,
            offsety:	0,
            x:			0,			// current position, it has to be given to the accession szogebol ass, from a distance.
            y:			0,
